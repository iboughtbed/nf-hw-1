...
export const components = {
  ...
  pre: ({ className, ...props }: React.HtmlHTMLAttributes<HTMLPreElement>) => (
    <pre
      className={cn(
        "text-muted-foreground dark relative mb-4 mt-6 max-h-[640px] overflow-x-auto rounded-lg border p-4 font-mono text-sm font-semibold dark:!bg-[#0a0a0a]",
        className,
      )}
      {...props}
    />
  ...
  code: ({ className, ...props }: React.HTMLAttributes<HTMLElement>) => (
    <code
      className={cn(
        "bg-muted relative rounded py-[0.2rem] font-mono text-sm dark:bg-[#0a0a0a]",
        className,
      )}
      {...props}
    />
...
export function Mdx({ code }: MdxProps) {
  ...
  return (
    <div className="prose dark:prose-invert overflow-hidden">
